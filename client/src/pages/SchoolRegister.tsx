      ...
      <div className="my-24 max-w-6xl mx-auto">
        ...
        <div className="mt-1">
          <table className="border border-gray-400 w-[1175px] h-[203px]">
            <tr className="text-center border border-gray-400 my-3">
              <td className=" border border-gray-400 bg-slate-200 w-[310px] p-2">
                Type of User
              </td>
              <td className="text-left pl-10">School Member</td>
            </tr>
        ...
        <div className="mt-10 pt-10">
          ...
          <div className="mt-1">
                ...
                <td className="">
                  <div className="flex ml-10">
                    ...
                    <div className="flex mr-3">
                      <Button className="btn h-12 ml-10 my-2">Address</Button>
                ...
                <td className="py-2">
                  <div className="flex w-full ml-10">
                    <InputField
                      ...
                      name="Department"
                      placeholder={""}
                      className="my-2 p-[0.75rem] pl-0 pr-1 pb-2"
                    />
                    <label className="pl-2 pr-3 my-auto">
                    ...
                    />
                    <label className="pl-2 my-auto">Health Room</label>
                  </div>
                </td>
              </tr>
              <tr className="text-center border border-gray-400">
            ...
            <h3 className="mt-10">Websiter User Information Register</h3>
            <div className="mt-1">
              <table className="border border-gray-400 w-[1175px] h-[203px]">
                <tr className="text-center border border-gray-400 my-3">
